---
title: "Poverty and Inequality Platform (PIP): an introduction using R and Stata"
date: "August 2026"
author: 
...
format:
  revealjs:
    ...
    # chalkboard is disabled because it is incompatible with embed-resources (self-contained)
    # preview-links: auto
...
```{stata, eval=FALSE}
*| echo: true
* version() takes the full data version string (format %Y%m%d_YYYY_RV_AV_SSS),
* mirroring R's version argument. Alternatively use release() + ppp_year().
