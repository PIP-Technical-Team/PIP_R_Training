...
## PIP: Quality, accessibility, and transparency {.smaller}
...
graph twoway line headcount year, by(reporting_level) xtitle("") ytitle("Extreme poverty in China, 1990-2022")
...
list year headcount comparable_spell welfare_type
```
...
-   Diana C. Garcia Rojas: [dgarciarojas\@worldbank.org](mailto:drojas@worldbank.org){.email}
...
-   Anubhava Singla: [asingla1\@worldbabnk.org](mailto:asingla1@worldbabnk.org){.email}
